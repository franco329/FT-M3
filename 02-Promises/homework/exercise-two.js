...
function problemA () {
  ...
  // ???
  //-------------------------------------------------------------------------
  // PROMISE.ALL EJECUTA UN SUCCES HANDLER => CUANDO TODAS LAS PROMESAS SE HAYAN RESUELTO
  // PROMISE.ALL EJECUTA UN ERROR HANDLER => CUANDO UNA DE TODAS LAS PROMESAS SE HAYA RECHAZADO
...
function problemB () {
  ...
  // SE CONVIERTE EL ARRAY DE ARCHIVOS EN UN ARRAY DE PROMESAS
  const promises = filenames.map((files) => promisifiedReadFile(files));
