...
function problemA () {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-01.txt').then((resp) => blue(resp))
...
function problemB () {
  ...
  // ???
    ...
    promisifiedReadFile('poem-one/stanza-02.txt').then((resp) => blue(resp));
    promisifiedReadFile('poem-one/stanza-03.txt').then((resp) => blue(resp))
}
